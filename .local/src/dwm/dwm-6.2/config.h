...
static const char *email_client_cmd[]              = { "xterm", "-e", "neomutt", NULL    };
static const char *htop_cmd[]                      = { "xterm", "-e", "htop", NULL       };
...
static const char *music_player_cmd[]              = { "xterm", "-e", "ncmpcpp", NULL    };
